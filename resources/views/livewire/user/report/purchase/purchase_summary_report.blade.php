<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark page-title">Purchase Summary</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <div class="mg-b-7">
                        <div class="text-right">
                            ...
                            <a href="{{url('export/report-purchase-summary?from_date='.$from_date.'&to_date='.$to_date)}}" target="_blank" class="btn btn-secondary btn-sm wd-90"><i class="fa fa-file-excel"></i> &nbsp;Export</a>&nbsp;
                            @endif
                            @if(in_array(config('app.roles')['report_print'], json_decode(auth()->user()->roles)))
                            <a href="{{url('print/report-purchase-summary?from_date='.$from_date.'&to_date='.$to_date)}}" target="_blank" class="btn btn-info btn-sm wd-90"><i class="fa fa-print"></i> &nbsp;Print</a>&nbsp;
                            @endif
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="table-responsive">
                        <table class="table-width-expense table table-striped table-bordered table-hover">
                            ...
                            <tr class="bg-lightblue">
                                ...
                                <th class="th-32p th-100px">Date</th>
                                <th class="th-32p th-100px text-center">Total Purchase</th>
                                <th class="th-32p th-80px text-center">Purchase Amount</th>
                            </tr>
                            </thead>

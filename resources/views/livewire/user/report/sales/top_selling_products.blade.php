<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark page-title">Top Products</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <div class="mg-b-7">
                        <div class="text-right">
                            ...
                            <a href="{{url('export/report-sales-top-products?from_date='.$from_date.'&to_date='.$to_date)}}" target="_blank" class="btn btn-secondary btn-sm wd-90"><i class="fa fa-file-excel"></i> &nbsp;Export</a>&nbsp;
                            @endif
                            @if(in_array(config('app.roles')['report_print'], json_decode(auth()->user()->roles)))
                            <a href="{{url('print/report-sales-top-products?from_date='.$from_date.'&to_date='.$to_date)}}" target="_blank" class="btn btn-info btn-sm wd-90"><i class="fa fa-print"></i> &nbsp;Print</a>&nbsp;
                            @endif
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="table-responsive">
                        <table class="table-width-expense table table-striped table-bordered table-hover">
                            ...
                            <tr class="bg-lightblue">
                                <th class="th-8p th-40px text-center" style="padding:12px !important;">#</th>
                                <th class="th-50p th-100px">Product Name</th>
                                <th class="th-15p th-100px text-center">Total Sale</th>
                            </tr>
                            </thead>

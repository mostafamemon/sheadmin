    ...
    <div class="col-md-12">
        <div class="card card-lightblue">
            <div class="card-header">
                <h3 class="card-title"><i class="fa fa-edit"></i> &nbsp;Update Supplier</h3>
            </div>
            <form wire:submit.prevent="update" style="margin-bottom:0px">
                ...
                <div class="card-footer">
                    <div class="float-left">
                        <a href="/supplier?page={{$pre_page}}" class="btn btn-warning"><i class="fa fa-chevron-left tx-14"></i> Back</a>
                    </div>
